...
class RecyclerAdapterJAcksMixes(private val Data: List<JacksMixes>, private val onRecyclerViewClick : OnRecyclerViewClick) :
    RecyclerView.Adapter<RecyclerAdapterJAcksMixes.MyViewHolder>() {
