...
import com.amrhishammahmoud.uncleJacks.databinding.FragmentAccountBottomNavBinding
        ...
        binding.apply {
            ...
            binding.privacyBtn.setOnClickListener {
                val urlIntent = Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse("https://sites.google.com/view/amrhishamunclejacks/%D8%A7%D9%84%D8%B5%D9%81%D8%AD%D8%A9-%D8%A7%D9%84%D8%B1%D8%A6%D9%8A%D8%B3%D9%8A%D8%A9")
                )
...
private fun restoreDataBySharedPreferences() {
    ...
    private fun saveDataBySharedPreferences(){
    val sharedPreferences2 : SharedPreferences = requireContext().getSharedPreferences("myData2",
        Context.MODE_PRIVATE)
    val editor =sharedPreferences2.edit()
    editor.putString("phone",binding.phoneNumber.text.toString().trim())
    editor.putString("email",binding.emailAddress.text.toString().trim())
